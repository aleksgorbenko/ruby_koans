...
class AboutSymbols < Neo::Koan
  ...
  # dont see much use it such symbols (atm), could get confusing.
  ...
  #
  # Symbols are immutable. They are created once but not destroyed up until the program exits, therefore is you create too much of them you can too much of your memory
end
