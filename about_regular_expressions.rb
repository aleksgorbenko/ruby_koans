...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_failed_match_returns_nil
    assert_equal nil, "some matching content"[/missing/] # if we search for full word and it doesnt match we get nil NOT ""!
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "", "abbcccddddeeeee"[/z*/] # if one charatcter - we can get an empty string

    # THINK ABOUT IT:
    #
    # When would * fail to match? If we would have more than one character and the second one would be asent
  end
