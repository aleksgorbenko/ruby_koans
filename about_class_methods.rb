...
class AboutClassMethods < Neo::Koan
  ...
  # I would prefer the first one, but I would use the second one to make it visually stand out (if i have lots of instance methods in a class, it could be the way to group them together). ------------------------------------------------------------------
