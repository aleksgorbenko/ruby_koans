...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    # method works only for existing variables of a particular object
    fido.set_name("Fido")
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # name argument is required, without it we get arg error 0 for 1
    # if there would be a default value - no argument then
  end
